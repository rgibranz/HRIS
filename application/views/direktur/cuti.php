        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <h5><?= $list_cuti->sisa_cuti_k ?></h5>
                    <input type="text" value="<?= $list_cuti->sisa_cuti_k ?>" name="sisa_cuti" class="form-control" id="exampleInputEmail1" placeholder="Sisa Cuti" hidden>
                </div>
            </div>
