    ...
    <div class="card-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="text" name="no_hp" class="form-control" id="exampleInputEmail1" placeholder="Nama Karyawan">
        </div>
        ...
        <div class="form-group">
          ...
          <input type="passsword" name="password" class="form-control" placeholder="password">
        </div>
